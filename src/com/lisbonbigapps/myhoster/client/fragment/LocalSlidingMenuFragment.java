...
public class LocalSlidingMenuFragment extends Fragment {
    View view;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
	setHasOptionsMenu(true);
	view = inflater.inflate(R.layout.sliding_menu_local, container, false);

	View v = view.findViewById(R.id.layoutMenuServices);
